...
const CardTour = ({ tour }) => {
  return (
    <div className="max-w-sm rounded-xl overflow-hidden shadow-lg bg-gradient-to-r from-green-300 to-teal-400 transform transition-all duration-300 hover:shadow-xl">
      {/* Hình ảnh Tour */}
      ...
      <div className="flex flex-col justify-between p-6 bg-white/80 backdrop-blur-sm rounded-b-xl h-full">
        {/* Địa điểm */}
