    ...
    <div className="max-w-sm rounded-xl overflow-hidden shadow-lg bg-gradient-to-r from-green-300 to-teal-400">
      ...
      <div className="p-6 bg-white/80 backdrop-blur-sm rounded-b-xl">
        ...
        <button className="w-full flex justify-end">
          <p className="w-[120px] py-2 rounded border border-transparent bg-green-500 text-white hover:border-green-500 hover:text-green-500 transition duration-300">
            Đặt ngay
          </p>
        </button>
      </div>
