...
const CardTour = ({ tour }) => {
  return (
    <div className="max-w-sm rounded-xl overflow-hidden shadow-lg bg-gradient-to-r from-green-300 to-teal-400 transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
      {/* Hình ảnh Tour */}
