            ...
            <li key={index} className="relative">
              {item.dropdown ? (
                ...
                >
                  ...
                  {isDropdownOpen && (
                    <div
                      className="absolute left-0 top-[25px] t-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-10 transform transition-all duration-300 ease-in-out"
                      style={{
