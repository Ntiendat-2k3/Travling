      ...
      <div className="mb-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full mb-2 p-2 border border-gray-300 rounded-md outline-none focus:border focus:border-dark2d"
          ...
          <input
            ...
            onChange={handlePriceChange}
            className="w-full mb-4 p-2 border border-gray-300 rounded-md outline-none focus:border focus:border-dark2d"
