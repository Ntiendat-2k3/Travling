  ...
  return (
    <div className="max-w-sm rounded-xl overflow-hidden shadow-lg bg-gradient-to-r from-green-300 to-teal-400">
      ...
      <div className="p-6 bg-white/80 backdrop-blur-sm rounded-b-xl">
        ...
        {/* Nút đặt tour */}
        <button className="text-green-500 py-2 px-4 rounded transition duration-300">
          <span className="text-green-500 py-2 px-4 rounded transition duration-300">Đặt Ngay</span>
        </button>
      </div>
    </div>
  );
