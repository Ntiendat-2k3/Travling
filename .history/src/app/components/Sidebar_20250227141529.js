...
import { FaMapMarkerAlt, FaMoneyBillAlt } from "react-icons/fa"; // Icons cho địa điểm và giá
import { Transition } from "@headlessui/react"; // Thêm Transition từ Headless UI cho hiệu ứng đẹp mắt
        ...
        <div className="space-y-2">
          <label className="flex items-center">
            <input
              ...
              className="mr-2 w-4 h-4 border-2 border-gray-400 rounded-sm accent-green-500"
            />
            Hà Nội
          </label>
          <label className="flex items-center">
