    ...
    <div>
      ...
      <div className="flex justify-center mt-6">
        <ReactPaginate
          ...
          previousClassName={
            " py-1 rounded-md text-white bg-dark2d hover:bg-[#3c3b70] transition duration-300"
          }
          nextClassName={
            "px-3 py-1 rounded-md text-white bg-dark2d hover:bg-[#3c3b70] transition duration-300"
          }
        />
      </div>
    </div>
